...
- O conteúdo escrito em Markdown (`aulaNN_tema.md`) — referência completa para o aluno, com os blocos pedagógicos da disciplina (conceito profundo, conceito simplificado, visualização gráfica, problema motivador, analogias, exercícios e referências; aulas de implementação adicionam o bloco de código em C).
...
|---|------|------|------------------|--------------|
| 01 | Tipos Abstratos de Dados (TAD) | Conceitual | [aula01_tad/aula01_tad.md](aula01_tad/aula01_tad.md) | [aula01_tad/apresentacao.html](aula01_tad/apresentacao.html) |
...
- **Numeração**: pastas com dois dígitos (`aula01_`, `aula02_`, ...).
